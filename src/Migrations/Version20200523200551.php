 ...
 */
final class Version20200523200551 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wishlist DROP INDEX UNIQ_9CE12A319395C3F3, ADD INDEX IDX_9CE12A319395C3F3 (customer_id)');
        $this->addSql('ALTER TABLE wishlist DROP INDEX UNIQ_9CE12A314584665A, ADD INDEX IDX_9CE12A314584665A (product_id)');
        $this->addSql('ALTER TABLE wishlist CHANGE customer_id customer_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_has_order CHANGE order_id order_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE wishlist DROP INDEX IDX_9CE12A314584665A, ADD UNIQUE INDEX UNIQ_9CE12A314584665A (product_id)');
        $this->addSql('ALTER TABLE wishlist DROP INDEX IDX_9CE12A319395C3F3, ADD UNIQUE INDEX UNIQ_9CE12A319395C3F3 (customer_id)');
        $this->addSql('ALTER TABLE wishlist CHANGE product_id product_id INT DEFAULT NULL, CHANGE customer_id customer_id INT DEFAULT NULL');
    }
}
