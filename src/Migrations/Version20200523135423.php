 ...
 */
final class Version20200523135423 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_has_order CHANGE order_id order_id INT NOT NULL, CHANGE product_id product_id INT NOT NULL');
    }
}
